...
C;X103;Y2;K"C:\Program Files (x86)\Microsoft Office\AppXManifest.xml"
C;X103;Y3;K0;EFOPEN(R2C103, 2)
...
C;X100;Y12;K0;ESET.VALUE(R1C1, "AAAAAA")
C;X100;Y13;K0;ESET.VALUE(R2C1, "BBBBBB")
C;X100;Y14;K0;ESET.VALUE(R3C1, "CCCCCC")
